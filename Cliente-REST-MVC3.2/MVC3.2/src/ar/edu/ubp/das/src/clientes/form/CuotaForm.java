...
public class CuotaForm extends DynaActionForm {
	...
	public String toString() {
		return "CuotaForm [dniCliente=" + dniCliente + ", idPlan=" + idPlan + ", idCuota=" + idCuota + ", importe="
				+ importe + ", fechaVencimiento=" + fechaVencimiento + ", pagada=" + pagada + "]";
	}
